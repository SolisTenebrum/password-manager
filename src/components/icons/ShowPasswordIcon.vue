...
<template>
  <div class="icon-container">
    <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
      y="0px" width="512px" height="512px" viewBox="0 0 512 512" xml:space="preserve" class="show-password-icon"
    ...
    <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
      y="0px" width="512px" height="512px" viewBox="0 0 512 512" xml:space="preserve" class="animated-line"
      :class="{ 'active': isActive }">
      <line x1="96" y1="96" x2="416" y2="416" stroke="white" stroke-width="100" stroke-linecap="round" />
    </svg>
  </div>
</template>
